...
import (
	...
	"github.com/wjiec/programming_k8s/sample_controller/pkg/clientset/versioned"
	"github.com/wjiec/programming_k8s/sample_controller/pkg/informers/externalversions"
)
